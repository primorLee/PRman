...
- Treat `ready` as eligibility to ask a human, not as approval or a correctness proof.
- Re-check the diff and test evidence after the last edit before asking for confirmation.
